...
const Features = () => {
 return (
  <div className="font-[sans-serif] text-[#333] bg-gradient-to-t from-gray-800 to-gray-700 my-4">
   <div className="grid lg:grid-cols-3 md:grid-cols-2 max-md:max-w-lg mx-auto gap-12">
    <div className="p-4 flex items-center">
     <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="currentColor"
      className="w-12 h-12 mr-6 bg-blue-100 p-3 rounded-md shrink-0"
      viewBox="0 0 32 32"
     >
      <path
    ...
    <div className="p-4 flex items-center">
     ...
     <div>
      <h3 className="text-xl font-semibold mb-2 text-gray-300">Security</h3>
      <p className="text-gray-400 text-sm">
    ...
    <div className="p-4 flex items-center">
     ...
     <div>
      <h3 className="text-xl font-semibold mb-2 text-gray-300">Support</h3>
      <p className="text-gray-400 text-sm">
